...
class OverviewPageLocator:
    ...
    PAY_INFO = (By.XPATH, "//*[@id='checkout_summary_container']/div[1]/div[2]/div[2]")
    SAUCE_CARD = (By.CLASS_NAME, "summary_value_label")
    SHIPPING_INFO = (
        By.XPATH,
        "//*[@id='checkout_summary_container']/div[1]/div[2]/div[4]",
    )
