...
class TestYourInfoPage:
    ...
    def test_checkout_layout1(self, driver):

        page = self.open_page(driver)
        inventory_items = page.find_items_cards()
        randon_num = random.randint(1, conf.ITEMS_COUNTER)
        ...
        assert driver.current_url == conf.YOUR_INFO_URL
    ...
    def test_checkout_layout2(self, driver):
    ...
    def test_checkout_all_fields_are_filled(self, driver):
        ...
        page.click_continue()
        assert driver.current_url == conf.OVERVIEW_URL

    @allure.epic("Checkout: Your Information Page Test")
    @allure.story("TC_005._ all fields are empty")
    def test_checkout_fields_are_empty1(self, driver):
    ...
    def test_checkout_fields_are_empty2(self, driver):
    ...
    def test_checkout_fields_are_empty3(self, driver):
    ...
    def test_checkout_fields_are_empty4(self, driver):
