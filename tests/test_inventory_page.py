...
class TestInventoryPage:
    def login_standard_user(self, driver):
    ...
    @pytest.mark.xfail
    def test_inventory_page_content(self, driver):
        page = self.login_standard_user(driver)
        ...
        assert (
            inventory_item_names_count == conf.ITEMS_COUNTER
            and inventory_item_descs_count == conf.ITEMS_COUNTER
            and inventory_item_img_lnk_count == conf.ITEMS_COUNTER
    ...
    def test_inventory_page_sorting_by_price(self, driver, sorting):
        page = self.login_standard_user(driver)
    ...
    def test_inventory_page_sorting_by_name(self, driver, sorting):
        page = self.login_standard_user(driver)
        page.set_sorting_order(sorting)
        inventory_items = page.find_items_cards()
